...
app('router')->get('personal/account/login/social-network/callback/{name}', array('as' => 'telenok.auth.callback.social-network', 'uses' => 'App\Telenok\Account\Widget\Login\Controller@redirectSocialNetwork'));
